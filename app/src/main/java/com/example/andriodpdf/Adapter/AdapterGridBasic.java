        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            view.lyt_parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mOnItemClickListener != null) {
                        mOnItemClickListener.onItemClick(view, items.get(currentPos), holder.getAdapterPosition());
                    }
                }
            });
            view.lyt_parent.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    mOnItemClickListener.onItemLongClick(v, items.get(currentPos), holder.getAdapterPosition());
                    return true;
                }
            });
