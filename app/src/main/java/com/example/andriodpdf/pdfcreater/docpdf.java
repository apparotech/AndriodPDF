...
import com.example.andriodpdf.Adapter.CollageViewerAdapter;
import com.example.andriodpdf.Adapter.ImageDocument;
import com.example.andriodpdf.ImageToPDF;
import com.example.andriodpdf.PDFCreater;
import com.example.andriodpdf.R;
import com.example.andriodpdf.TouchUtils.LockableScrollView;
import com.example.andriodpdf.TouchUtils.MultiTouchListener;
...
public class docpdf {
    ...
    public docpdf(PDFCreater creater){
    ...
    private FlexboxLayout getTabLayout(int position, boolean value) {
        ...
        if (layouts.containsKey(position)) {
            ...
            int color = createrActiviry.getResources().getColor(colorRes);
